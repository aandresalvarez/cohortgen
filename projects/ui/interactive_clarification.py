...
class InteractiveClarificationSession:
    ...
    def _extract_initial_demographics(self):
        ...
        result = self.demographics_extractor.run_sync(self.initial_description)
...
"""
        ...
        decision = result.output  # Type: ClarificationDecision
        ...
        if decision.action == "finish" or self.question_count >= self.max_questions:
            ...
            self.conversation_history.append({"role": "assistant", "content": decision.question})
